...
- **Query an API** — paste a URL from the reference list (or your own) and set parameters
...
or API key (or use a free demo key). Click any base URL to open its documentation.
    """)
...
> this is itself an important methodological distinction to understand.
    ...
    byod_raw = None  # will hold the collected data
